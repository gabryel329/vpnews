        ...
        <div class="row py-4">
            <div class="col-md-6 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        <span class="c_g d-block" style="color: white">Telefone</span>
                        <span class="d-block c_g fh5co_contact_us_no_text" style="color: white">{{$configuracao->telefone}}</span>
                    </div>
            ...
            <div class="col-md-6 py-3">
                <div class="row fh5co_contact_us_no_icon_difh5co_hover">
                    ...
                    <div class="col-9 align-self-center fh5co_contact_us_no_icon_difh5co_hover_2">
                        <span class="c_g d-block" style="color: white">E-mail</span>
                        <span class="d-block c_g fh5co_contact_us_no_text" style="color: white">{{$configuracao->email}}</span>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
